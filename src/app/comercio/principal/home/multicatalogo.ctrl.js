(function() {
    ...
    $scope.confirmSearch = function (){
      ...
      sellerService.getSellersWithTags(selectedTags).then(function(response){
        $scope.catalogs = response.data.data.map(function(c){
          c = sellerService.normalizadorVendedores(c);
    ...
    function init(){
      ...
      sellerService.getSellersTags().then(function(response){
        $scope.tags = sellerService.normalizadorSellersTags(response.data.data);
        //$scope.tags = response.data;
        //$scope.tags = sellerData;
      })
